      ...
      >
        <div className="inline-flex flex-col items-center md:items-start space-y-6">
          ...
          <div className="inline-flex items-center md:items-start flex-col text-4xl md:text-7xl font-bold tracking-widest leading-10 uppercase">
            <div>
              <span className="text-stroke">Nare</span>sh
            </div>
            <div className="text-2xl md:text-7xl">Jhawar</div>
          </div>
          <div className="max-w-3xl text-center md:text-left">
            I’m Naresh Jhawar, a developer and designer with expertise 
            building Blockchain, mobile, and web applications. Skilled in Agile 
            Workflow, Data Structures, Operating Systems, and DevOps. 
