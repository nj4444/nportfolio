  ...
  return (
    <>
      ...
      >
        ...
        {/* <bg-dark></bg-dark> */}
          <div className="relative w-full lg:grid-cols-12  text-light h-screen grid grid-cols-6 lg:gap-6 antialiased herosect">
            <motion.div
              variants={itemLeft}
            ...
            <motion.div
              variants={itemRight}
              className="absolute h-96 lg:h-full top-32 lg:top-0 w-full lg:w-10/12 col-span-full lg:right-2 h-full"
            >
        ...
        <section data-scroll-section className="relative">
          ...
          <div>
            <div>
              <Marquee gradient={true} gradientColor={[16, 16, 28]}>
                <div
                  data-scroll
          ...
          <div className="relative py-24 w-full place-items-center md:grid-cols-8 p-10 text-light grid grid-cols-4 space-y-10  md:gap-6 antialiased">
